# -*- coding: utf-8 -*-
"""
Testcase Generator for khuyenmai_keo
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai KHUYENMAI_KEO
    Constraint: 1 <= n <= 1000
    Logic: 10 vo doi 3 keo moi, simulation
    """
    print("Generating testcases for khuyenmai_keo...")
    
    test_inputs = []
    
    # Test 1: n=1 (qua it de doi)
    test_inputs.append("1\n")
    
    # Test 2: Vi du de bai n=10
    test_inputs.append("10\n")
    
    # Test 3: n=9 (chua du de doi)
    test_inputs.append("9\n")
    
    # Test 4: n=20
    test_inputs.append("20\n")
    
    # Test 5: n=30 (du de doi 2 lan)
    test_inputs.append("30\n")
    
    # Test 6: n=100
    test_inputs.append("100\n")
    
    # Test 7: n=250
    test_inputs.append("250\n")
    ...
    # Test 11: Random
    test_inputs.append("777\n")
    
    # Test 10: Max n=1000
    test_inputs.append("1000\n")
    
    # Test 11: n=13 (edge case)
    test_inputs.append("13\n")
...
def create_zip():
    ...
    zip_name = "khuyenmai_keo_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: khuyenmai_keo")
    print("="*60)
