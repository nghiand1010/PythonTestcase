# -*- coding: utf-8 -*-
"""
Testcase Generator for sapxepcs
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai SAPXEPCS
    Constraint: 0 <= N <= 10^18
    Logic: Sort chu so tang dan, loai bo leading 0
    Strategy: Phan bo deu so lon
    """
    print("Generating testcases for sapxepcs...")
    ...
    # Test 3: Vi du - co leading 0
    test_inputs.append("1000\n")
    
    # Test 4: Vi du de bai
    test_inputs.append("999968677\n")
    
    # Test 5: 10^6 - giam dan
    test_inputs.append("987654\n")
    
    # Test 6: 10^9
    test_inputs.append("5837294610\n")
    
    # Test 7: 10^12
    test_inputs.append("987654321012\n")
    
    # Test 8: 10^15
    test_inputs.append("123456789012345\n")
    
    # Test 9: Gan 10^18
    test_inputs.append("123456789012345678\n")
    
    # Test 10: Max N (10^18)
    test_inputs.append("999999999999999999\n")
    
    # Test 11: Random
    test_inputs.append("10203040506\n")
...
def create_zip():
    ...
    zip_name = "sapxepcs_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: sapxepcs")
    print("="*60)
