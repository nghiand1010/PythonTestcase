# -*- coding: utf-8 -*-
"""
Testcase Generator for toan_hoc
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai TOAN_HOC
    Logic: Sort phep cong '1+3+2' -> '1+2+3'
    """
    print("Generating testcases for toan_hoc...")
    ...
    # Test 2: Can sort
    test_inputs.append("3+2+1\n")
    
    # Test 3: Vi du de bai
    test_inputs.append("1+3+2+1\n")
    
    # Test 4: Chi co 1 so
    test_inputs.append("2\n")
    
    # Test 5: 2 so
    test_inputs.append("3+1\n")
    
    # Test 6: Nhieu so
    test_inputs.append("2+1+3+1+2+3+1+1+3+2\n")
    
    # Test 7: Tat ca 1
    test_inputs.append("1+1+1+1+1\n")
    
    # Test 8: Tat ca 3
    test_inputs.append("3+3+3+3\n")
    
    # Test 9: Mixed
    test_inputs.append("2+3+1+2+3+1\n")
    
    # Test 10: Long string
    test_inputs.append("+".join(["1", "3", "2"]*10) + "\n")
    
    # Test 11: Max length ~100 chars
    test_inputs.append("+".join([str((i%3)+1) for i in range(50)]) + "\n")
    test_inputs.append("+".join(["1","3","2"]*10) + "\n")
    
    # Test 11: Reverse order
    test_inputs.append("3+3+3+2+2+1\n")
...
def create_zip():
    ...
    zip_name = "toan_hoc_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: toan_hoc")
    print("="*60)
