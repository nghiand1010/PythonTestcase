# -*- coding: utf-8 -*-
"""
Testcase Generator for bdsochia2
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai BDSOCHIA2
    Constraint: 1 <= N <= 10^18
    Strategy: Phan bo thong minh voi so lon
    """
    print("Generating testcases for bdsochia2...")
    
    test_inputs = []
    
    # Test 1: N=1 (ket qua = 0)
    test_inputs.append("1\n")
    
    # Test 2: N=2 (power of 2)
    test_inputs.append("2\n")
    
    # Test 3: N=15 (vi du de bai)
    test_inputs.append("15\n")
    
    # Test 4: Power of 2 lon
    test_inputs.append("1024\n")
    
    # Test 5: So le dac biet
    test_inputs.append("999999\n")
    
    # Test 6: 10^6
    test_inputs.append("1000000\n")
    
    # Test 7: 10^9
    test_inputs.append("1000000000\n")
    
    # Test 8: 10^12
    test_inputs.append("1000000000000\n")
    
    # Test 9: 10^15
    test_inputs.append("1000000000000000\n")
    
    # Test 10: Gan max 10^18
    test_inputs.append("999999999999999999\n")
    
    # Test 11: Random number (cho co)
...
def create_zip():
    ...
    zip_name = "bdsochia2_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: bdsochia2")
    print("="*60)
