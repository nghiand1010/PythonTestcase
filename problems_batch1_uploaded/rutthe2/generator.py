# -*- coding: utf-8 -*-
"""
Testcase Generator for rutthe2
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai RUTTHE2
    Constraint: 1 <= N <= 10^9
    Logic: Day 1..N, 2 nguoi rut tham lam tu 2 dau
           Sereja di truoc, cong thuc toan hoc
    """
    print("Generating testcases for rutthe2...")
...
def create_zip():
    ...
    zip_name = "rutthe2_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: rutthe2")
    print("="*60)
