# -*- coding: utf-8 -*-
"""
Testcase Generator for so_lonnhat
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai SO_LONNHAT
    Logic: Doi cho chu so de co so lon nhat (sort giam dan)
    """
    print("Generating testcases for so_lonnhat...")
    ...
    # Test 3: Da la max
    test_inputs.append("987654321\n")
    
    # Test 4: Da la min (can dao)
    ...
    # Test 9: Toan chu so giong nhau
    test_inputs.append("7777777\n")
    
    # Test 10: 10^6 digits
    test_inputs.append("123456789012345678901234567890\n")
    
    # Test 11: Max - gan 10^5 digits (if supported)
    test_inputs.append("9876543210"*5 + "\n")
    test_inputs.append("999999999999999999\n")
    
    # Test 11: Mix
    test_inputs.append("102938475660\n")
...
def create_zip():
    ...
    zip_name = "so_lonnhat_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: so_lonnhat")
    print("="*60)
