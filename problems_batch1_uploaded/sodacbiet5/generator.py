# -*- coding: utf-8 -*-
"""
Testcase Generator for sodacbiet5
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai SODACBIET5
    Logic: So lap dac biet - 2 chu so {1,2,3,4} xen ke, tim vi tri
    """
    print("Generating testcases for sodacbiet5...")
    
    test_inputs = []
    
    # Test 1: Dau tien - "12"
    test_inputs.append("12\n")
    
    # Test 2: "21"
    test_inputs.append("21\n")
    
    # Test 3: "121"
    test_inputs.append("121\n")
    
    # Test 4: "1212"
    test_inputs.append("1212\n")
    
    # Test 5: "343"
    test_inputs.append("343\n")
    
    # Test 6: "4343"
    test_inputs.append("4343\n")
    
    # Test 7: Khong phai (1 chu so)
    test_inputs.append("1\n")
    
    # Test 8: Khong phai (khong xen ke)
    test_inputs.append("1122\n")
    
    # Test 9: Khong phai (chu so ngoai {1,2,3,4})
    test_inputs.append("565\n")
    
    # Test 10: Dai hon
    test_inputs.append("12121212\n")
    
    # Test 11: Edge - "23232323"
    test_inputs.append("23232323\n")
...
def create_zip():
    ...
    zip_name = "sodacbiet5_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: sodacbiet5")
    print("="*60)
