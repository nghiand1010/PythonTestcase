# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_dso2
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai TICA_DSO2
    Logic: Tim so lon nhat < n va chia het 5
    """
    print("Generating testcases for tica_dso2...")
    ...
    # Test 4: n=10 (output 5)
    test_inputs.append("10\n")
    
    # Test 5: n=11 (output 10)
...
def create_zip():
    ...
    zip_name = "tica_dso2_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: tica_dso2")
    print("="*60)
