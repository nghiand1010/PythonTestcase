# -*- coding: utf-8 -*-
"""
Testcase Generator for xenke_vongtron
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai XENKE_VONGTRON
    Logic: Longest alternating substring (circular), co the co '?'
    """
    print("Generating testcases for xenke_vongtron...")
    
    test_inputs = []
    
    # Test 1: Khong co '?', alternating
    test_inputs.append("abacad\n")
    
    # Test 2: Khong co '?', co consecutive same
    test_inputs.append("aabbc\n")
    
    # Test 3: Co '?'
    test_inputs.append("a?b?c\n")
    
    # Test 4: Toan '?'
    test_inputs.append("?????\n")
    
    # Test 5: Tat ca giong nhau (non-?)
    test_inputs.append("aaaaa\n")
    
    # Test 6: Perfect alternating
    test_inputs.append("ababab\n")
    
    # Test 7: Single char
    test_inputs.append("a\n")
    
    # Test 8: Co '?' o giua
    test_inputs.append("abc?def?ghi\n")
    
    # Test 9: Circular wrapping
    test_inputs.append("abcda\n")
    
    # Test 10: Long string n=50
    test_inputs.append(("abcd"*12 + "ab") + "\n")
    
    # Test 11: Max n=100
    test_inputs.append(("a?b?c?d?"*12 + "a?b?") + "\n")
    test_inputs.append("abcd"*25 + "\n")
    
    # Test 11: Mix with '?'
    test_inputs.append("a?a?b?b?c?c?d?d?\n")
...
def create_zip():
    ...
    zip_name = "xenke_vongtron_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: xenke_vongtron")
    print("="*60)
