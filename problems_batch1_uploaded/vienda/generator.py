...
def generate_testcases():
    """
    Sinh 11 testcases cho bai VIENDA - Vien da ke nhau
    Constraint: 1 <= n <= 50, s in {R,G,B}
    Logic: Dem so cap ke nhau cung mau
    """
    print("Generating testcases for vienda...")
    ...
    # Test 2: Khong co cap giong nhau
    ...
    # Test 9: Nhieu cap lien tiep
    test_inputs.append("15\nRRRGGGBBBRRRGGG\n")
    
    # Test 10: Random mix
    test_inputs.append("20\nRGBGBRBGRBGRBGRBGRBG\n")
    
    # Test 11: All B
    test_inputs.append("30\n" + "B"*30 + "\n")
    
    # Test 10: Single color blocks
    test_inputs.append("20\nRRGGBBRRGGBBRRGGBBRR\n")
    
    # Test 11: Random
    test_inputs.append("30\nRGBRRGBBGRRBGGBRRGBBGRRBGGBRR\n")
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: vienda")
    print("="*60)
