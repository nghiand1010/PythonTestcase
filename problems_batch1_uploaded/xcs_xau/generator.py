# -*- coding: utf-8 -*-
"""
Testcase Generator for xcs_xau
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai XCS_XAU - Xoa chu so
    Logic: Xoa tat ca chu so trong string
    """
    print("Generating testcases for xcs_xau...")
    
    test_inputs = []
    
    # Test 1: Vi du de bai
    test_inputs.append("ab12cd34ef566\n")
    
    # Test 2: Khong co chu so
    test_inputs.append("abcdef\n")
    
    # Test 3: Toan chu so
    test_inputs.append("123456789\n")
    
    # Test 4: Bat dau bang chu so
    test_inputs.append("123abc\n")
    
    # Test 5: Ket thuc bang chu so
    test_inputs.append("abc123\n")
    
    # Test 6: Xen ke
    test_inputs.append("a1b2c3d4e5\n")
    
    # Test 7: Co dau cach
    test_inputs.append("hello 123 world 456\n")
    
    # Test 8: Mix
    test_inputs.append("test123string456with789numbers\n")
    
    # Test 9: Single char - chu
    test_inputs.append("a\n")
    
    # Test 10: Single char - so
    test_inputs.append("5\n")
    
    # Test 11: Long string
    test_inputs.append(("abc"*100 + "123"*50 + "def"*100) + "\n")
    test_inputs.append("5\n")
...
def create_zip():
    ...
    zip_name = "xcs_xau_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: xcs_xau")
    print("="*60)
