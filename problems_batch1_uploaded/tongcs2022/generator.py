# -*- coding: utf-8 -*-
"""
Testcase Generator for tongcs2022
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai TONGCS2022
    Logic: Tong N chu so dau cua "2022202220222022..."
    """
    print("Generating testcases for tongcs2022...")
    ...
    # Test 2: N=4 (2+0+2+2=6)
    test_inputs.append("4\n")
    
    # Test 3: N=5 (6+2=8)
    test_inputs.append("5\n")
    
    # Test 4: N=8 (2 cycles = 12)
    ...
    # Test 11: N=10^18 (neu co)
    test_inputs.append("1000000000000000000\n")
    test_inputs.append("1000000000\n")
...
def create_zip():
    ...
    zip_name = "tongcs2022_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: tongcs2022")
    print("="*60)
