...
def generate_testcases():
    """
    Sinh 11 testcases cho bai SODEP2
    Constraint: T <= 10^5, 1 <= a < b <= 10^16
    Logic: Dem so chu so 0 tan cung cua a*(a+1)*...b
    Strategy: Phan bo deu so lon
    """
    print("Generating testcases for sodep2...")
    ...
    # Test 3: Co nhieu so 5
    test_inputs.append("1\n5 25\n")
    
    # Test 4: Range vua (10^3)
    test_inputs.append("1\n1 1000\n")
    ...
    # Test 8: 10^15
    test_inputs.append("1\n1000000000000000 1000000000000050\n")
    
    # Test 9: Gan max 10^16
    test_inputs.append("1\n9999999999999990 9999999999999999\n")
    
    # Test 10: Nhieu testcases
    test_inputs.append("100\n" + "\n".join(f"{i*100} {i*100+10}" for i in range(1, 101)) + "\n")
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: sodep2")
    print("="*60)
