# -*- coding: utf-8 -*-
"""
Testcase Generator for thttd_ds
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai THTTD_DS
    Constraint: 1 < n < 10^15
    Logic: Day tam giac 1,3,6,10,15,21,..., dem so chia het 6
    """
    print("Generating testcases for thttd_ds...")
    ...
    # Test 2: n=3 (dau tien chia het 6)
    test_inputs.append("3\n")
    
    # Test 3: n=12 (1 nhom day du)
    test_inputs.append("12\n")
    
    # Test 4: n=24 (2 nhom)
    test_inputs.append("24\n")
    
    # Test 5: n=8 (co 2 so chia het 6: 3,8)
    test_inputs.append("8\n")
    
    # Test 6: n=11
    test_inputs.append("11\n")
    ...
    # Test 11: Max gan 10^15
    test_inputs.append("999999999999999\n")
...
def create_zip():
    ...
    zip_name = "thttd_ds_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: thttd_ds")
    print("="*60)
