# -*- coding: utf-8 -*-
"""
Testcase Generator for dayso_bimat
...
def generate_testcases():
    """
    Sinh 11 testcases cho bai DAYSO_BIMAT - Day 1,5,6,10,11,15,...
    Constraint: 1 < N < 10^12
    Logic: N le: 5k+1, N chan: 5k (k = N//2)
    """
    print("Generating testcases for dayso_bimat...")
    
    test_inputs = []
    
    # Test 1: N=2 (so chan dau)
    test_inputs.append("2\n")
    
    # Test 2: N=5 (vi du de bai)
    test_inputs.append("5\n")
    
    # Test 3: N=10 (vi du de bai)
    test_inputs.append("10\n")
    
    # Test 4: N=1 (so le dau)
    test_inputs.append("1\n")
    
    # Test 5: N=100 (subtask 1)
    test_inputs.append("100\n")
    
    # Test 6: N=99 (le)
    test_inputs.append("99\n")
    ...
    # Test 10: N=10^11
    test_inputs.append("100000000000\n")
    
    # Test 11: N gan max (10^12 - 1)
    test_inputs.append("999999999999\n")
...
def create_zip():
    ...
    zip_name = "dayso_bimat_testcases.zip"
...
if __name__ == "__main__":
    print("="*60)
    print(f"TESTCASE GENERATOR: dayso_bimat")
    print("="*60)
