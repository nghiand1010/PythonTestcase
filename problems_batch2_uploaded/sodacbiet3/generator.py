# -*- coding: utf-8 -*-
"""
Testcase Generator for sodacbiet3
"""
...
def generate_testcases():
    """
    Generate testcases for sodacbiet3
    Input: n (1 số)
    Constraints: 10 ≤ n ≤ 10¹⁸
    ...
    # Generate and save
    print(f"Generating testcases for sodacbiet3...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "sodacbiet3_testcases.zip")
    ...
    print(f"📦 Created ZIP: sodacbiet3_testcases.zip")
