# -*- coding: utf-8 -*-
"""
Testcase Generator for hk_matma
"""
...
def generate_testcases():
    """
    Generate testcases for hk_matma
    ...
    # Generate and save
    print(f"Generating testcases for hk_matma...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "hk_matma_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: hk_matma_testcases.zip")
