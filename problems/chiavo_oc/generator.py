# -*- coding: utf-8 -*-
"""
Testcase Generator for chiavo_oc
"""
...
def generate_testcases():
    """
    Generate testcases for chiavo_oc
    ...
    # Generate and save
    print(f"Generating testcases for chiavo_oc...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "chiavo_oc_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: chiavo_oc_testcases.zip")
