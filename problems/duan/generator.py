...
def generate_testcases():
    ...
    # Generate and save
    print(f"Generating testcases for duan...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "duan_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: duan_testcases.zip")
