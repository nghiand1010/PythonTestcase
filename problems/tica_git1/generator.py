# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_git1
"""
...
def generate_testcases():
    """
    Generate testcases for tica_git1
    Input: k - find k-th lucky number (containing only 4 and 7)
    Constraints: 1 <= k <= 10^9
    """
    test_cases = []
    
    # Test 1: First lucky number
    test_cases.append("1\n")
    
    # Test 2: Second lucky number
    test_cases.append("2\n")
    ...
    # Generate and save
    print(f"Generating testcases for tica_git1...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tica_git1_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tica_git1_testcases.zip")
