# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_tht22dna3
"""
...
def generate_testcases():
    """
    Generate testcases for tica_tht22dna3
    Triangle number sum: n ≤ 10^7
    """
    test_cases = []
    ...
    # Generate and save
    print(f"Generating testcases for tica_tht22dna3...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tica_tht22dna3_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tica_tht22dna3_testcases.zip")
