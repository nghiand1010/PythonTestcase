# -*- coding: utf-8 -*-
"""
Testcase Generator for lich_saohoa
"""
...
def generate_testcases():
    """
    Generate testcases for lich_saohoa
    ...
    # Generate and save
    print(f"Generating testcases for lich_saohoa...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "lich_saohoa_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: lich_saohoa_testcases.zip")
