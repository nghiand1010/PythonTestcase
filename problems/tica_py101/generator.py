# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_py101
"""
...
def generate_testcases():
    """
    Generate testcases for tica_py101
    ...
    # Generate and save
    print(f"Generating testcases for tica_py101...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tica_py101_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tica_py101_testcases.zip")
