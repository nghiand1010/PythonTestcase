...
def generate_testcases():
    ...
    Find smallest number with distinct digits summing to n: n ≤ 45
    """
    test_cases = []
    ...
    test_cases.append("40\n")            # n=40
    test_cases.append("45\n")            # n=45 (max: 123456789 sum=45)
    
    # Test 11: Random
    test_cases.append(f"{random.randint(1, 45)}\n")
...
def create_zip():
    ...
    print(f"[ZIP] Created ZIP: tongcs2_testcases.zip")
