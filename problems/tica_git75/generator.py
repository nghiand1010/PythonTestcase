# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_git75
"""
...
def generate_testcases():
    """
    Generate testcases for tica_git75
    ...
    # Generate and save
    print(f"Generating testcases for tica_git75...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tica_git75_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tica_git75_testcases.zip")
