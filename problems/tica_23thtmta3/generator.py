# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_23thtmta3
"""
...
def generate_testcases():
    """
    Generate testcases for tica_23thtmta3
    Three integers input (example: 25,10,3 → 7)
    """
    test_cases = []
    ...
    # Generate and save
    print(f"Generating testcases for tica_23thtmta3...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tica_23thtmta3_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tica_23thtmta3_testcases.zip")
