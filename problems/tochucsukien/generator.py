# -*- coding: utf-8 -*-
"""
Testcase Generator for tochucsukien
"""
...
def generate_testcases():
    """
    Generate testcases for tochucsukien
    Group assignment: n, t, X
    """
    test_cases = []
    ...
    t = random.randint(1000, min(n, 10**6))
    x = random.randint(1, n // t)
    test_cases.append(f"{n}\n{t}\n{x}\n")
    
    # Generate and save
    print(f"Generating testcases for tochucsukien...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tochucsukien_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tochucsukien_testcases.zip")
