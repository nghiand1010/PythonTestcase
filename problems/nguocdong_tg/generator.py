# -*- coding: utf-8 -*-
"""
Testcase Generator for nguocdong_tg
"""
...
def generate_testcases():
    """
    Generate testcases for nguocdong_tg
    Input: s (day number since epoch) - convert to date
    ...
    # Generate and save
    print(f"Generating testcases for nguocdong_tg...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "nguocdong_tg_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: nguocdong_tg_testcases.zip")
