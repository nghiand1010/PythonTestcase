# -*- coding: utf-8 -*-
"""
Testcase Generator for chuky_theky
"""
...
def generate_testcases():
    """
    Generate testcases for chuky_theky
    ...
    # Generate and save
    print(f"Generating testcases for chuky_theky...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "chuky_theky_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: chuky_theky_testcases.zip")
