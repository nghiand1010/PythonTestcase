...
def generate_testcases():
    ...
    # Test 1-3: Edge cases
    test_cases.append("30 50")       # Sample
    test_cases.append("11 20")       # Small range near min
    test_cases.append("99990 99999") # Near max
    
    # Test 4-10: Scale from small to 10^5
    test_cases.append("11 100")
    test_cases.append("100 500")
    test_cases.append("500 1000")
    test_cases.append("1000 5000")
    test_cases.append("5000 10000")
    test_cases.append("10000 50000")
    test_cases.append("50000 99999")  # Max range
    
    # Test 11: Random
    a = random.randint(11, 50000)
...
def create_zip():
    ...
    print(f"Created ZIP: lucky1_testcases.zip")
