...
def generate_testcases():
    ...
    # Test 1-3: Edge cases
    test_cases.append("1")   # Min
    test_cases.append("4")   # Example 1
    test_cases.append("6")   # Example 2
    
    # Test 4-10: Scale from 10² → 10^9
    test_cases.append("8")        # Example 3
    test_cases.append("100")
    test_cases.append("1000")
    test_cases.append("10000")
    test_cases.append("1000000")
    test_cases.append("100000000")
    test_cases.append("1000000000")  # 10^9 (max)
    
    # Test 11: Random
    test_cases.append(str(random.randint(500000000, 999999999)))
    
    # Generate and save
    print(f"Generating testcases for hcmdep...")
    for i, x_str in enumerate(test_cases, 1):
        try:
            input_data = x_str + "\n"
...
def create_zip():
    ...
    print(f"Created ZIP: hcmdep_testcases.zip")
