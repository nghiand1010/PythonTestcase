...
def generate_testcases():
    ...
    Triangle string problem: N (max 36 based on 8-layer triangle)
    """
    test_cases = []
    
    # Test 1-3: Edge cases
    test_cases.append("1\n")        # N=1: first char 'H'
    test_cases.append("8\n")        # N=8: sample (output: I, Green)
    test_cases.append("36\n")       # N=36: last position in 8-layer triangle
    ...
    # Test 11: Random
    test_cases.append(f"{random.randint(1, 36)}\n")
...
def create_zip():
    ...
    print(f"[ZIP] Created ZIP: tica_tinhoctre3_testcases.zip")
