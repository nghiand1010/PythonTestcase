# -*- coding: utf-8 -*-
"""
Testcase Generator for tica_tholac2
"""
...
def generate_testcases():
    """
    Generate testcases for tica_tholac2
    Formula based on N, output mod 10^6
    """
    test_cases = []
    ...
    # Generate and save
    print(f"Generating testcases for tica_tholac2...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tica_tholac2_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tica_tholac2_testcases.zip")
