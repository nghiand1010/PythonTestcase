# -*- coding: utf-8 -*-
"""
Testcase Generator for tongchux
"""
...
def generate_testcases():
    """
    Generate testcases for tongchux
    Input: m, n, x, y (4 lines) - compute diagonal sums
    ...
    # Generate and save
    print(f"Generating testcases for tongchux...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "tongchux_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: tongchux_testcases.zip")
