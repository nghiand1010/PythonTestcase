...
def generate_testcases():
    """
    Generate testcases for vienda
    Input: n, then string of n characters - count consecutive duplicates
    Constraints: 1 <= n <= 10^5, string of lowercase letters
    """
    test_cases = []
    ...
    # Generate and save
    print(f"Generating testcases for vienda...")
...
def create_zip():
    ...
    zip_path = os.path.join(SCRIPT_DIR, "vienda_testcases.zip")
    ...
    print(f"[ZIP] Created ZIP: vienda_testcases.zip")
