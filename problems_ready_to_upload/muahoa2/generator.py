...
def generate_testcases():
    ...
    Constraint: 1 ≤ a < b ≤ 1000, 0 ≤ c ≤ 100000
    """
    test_cases = []
    
    # Test 1-3: Edge cases
    test_cases.append("1 2 0\n")  # c=0, can't buy anything
    test_cases.append("2 3 11\n")  # Example from problem
    test_cases.append("1 2 1\n")  # Can only buy 1 rose
    
    # Test 4-10: Varied cases
    test_cases.append("5 10 100\n")
    test_cases.append("10 20 500\n")
    test_cases.append("50 100 1000\n")
    test_cases.append("100 200 5000\n")
    test_cases.append("200 500 10000\n")
    test_cases.append("500 1000 50000\n")
    test_cases.append("999 1000 100000\n")  # Max values
...
def create_zip():
    ...
    print(f"[ZIP] Created ZIP: muahoa2_testcases.zip")
